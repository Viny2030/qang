...
The library includes an automated test suite of 859 unit and regression tests, run in continuous integration on Python 3.9–3.12. It reproduces all analytical tables and every numerical finding cited above.
